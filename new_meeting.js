...
document.getElementById("building_text").required=true;
document.getElementById("room_text").required=true;

create.addEventListener("click", function () {
    var test_pass = false;
        if (document.getElementById("building_text").value == "") {
            missing_fields.classList.add("show");
            exit;
        } else {
            test_pass = true;
        }

        if (document.getElementById("room_text").value == "") {
            missing_fields.classList.add("show");
            exit;
        } else {
            test_pass = true;
...
closePopupOk.addEventListener("click", function () {
        missing_fields.classList.remove("show");
    }
);
